"use client";
import { use, Suspense, useState, JSX, useEffect } from "react";
...
const EventPageContent = ({ slug }: { slug: string }): JSX.Element => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setShowFloatingButton(window.pageYOffset > 300);
    };
      ...
      <main>
        <section ref={eventoRef} id="evento" className="py-5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <EventDisplay slug={slug} initialCpf={urlCpf} />
            </Suspense>
          </div>
        </section>
...
export default function EventPage({ params }: EventPageProps): JSX.Element {
